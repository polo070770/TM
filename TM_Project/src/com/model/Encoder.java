...
public class Encoder implements Runnable {
    ...
    private HashMap<Integer, ArrayList<BufferedImage>> frame_teselas = new HashMap<Integer, ArrayList<BufferedImage>>();
    ...
    private ArrayList<BufferedImage> buildTeselas(BufferedImage image) {
        ArrayList<BufferedImage> list_teseles = new ArrayList<BufferedImage>();
