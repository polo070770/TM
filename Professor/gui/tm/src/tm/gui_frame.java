...
public class gui_frame extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        selColorQuant = new javax.swing.JRadioButton();
        ...
        setMinimumSize(new java.awt.Dimension(522, 517));
        ...
        pixelTransBG.add(selColorQuant);
        selColorQuant.setText("Color Quantization");
        selColorQuant.setEnabled(false);
        selColorQuant.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selColorQuantActionPerformed(evt);
            }
        });
        ...
        backButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Rewind16.gif"))); // NOI18N
        ...
        forwardButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/FastForward16.gif"))); // NOI18N
...
//            Image img = new Image();
            Boolean err = false;
            try {
                Image img = new Image(fc.getSelectedFile());
                if (! err) {
                    this.updating = true;
                    if (this.fileSelected) 
                        clear();
    ...
    private void selColorQuantActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selColorQuantActionPerformed
        String sColLev = JOptionPane.showInputDialog(null,
                    "Color levels", "255");
        this.video.setColLevel(Integer.valueOf(sColLev));
        this.video.changeFilter(Filter.COLOR_QUANT, true);
    }//GEN-LAST:event_selColorQuantActionPerformed
...
//            this.video.loadEncVideo(encoder.encVid);
    ...
    private javax.swing.JRadioButton selColorQuant;
